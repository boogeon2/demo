...
#ifndef MULTIROBOT_UTILS__IMPL_PTR_HPP
#define MULTIROBOT_UTILS__IMPL_PTR_HPP
...
namespace multirobot_utils
{
  namespace details
  {
    ...
    {
      static_assert(sizeof(T) > 0 and !std::is_void<T>::value,
    ...
    struct is_default_manageable : public std::integral_constant<bool,
                                                                 std::is_same<D, default_deleter_t<T>>::value and
  ...
  public:
    ...
    unique_impl_ptr(U *u,
                    typename std::enable_if<
                        std::is_convertible<U *, pointer>::value and is_default_manageable::value,
                        dummy_t_>::type = dummy_t_()) noexcept
    ...
    template <class U>
    unique_impl_ptr(std::unique_ptr<U> and u,
                    typename std::enable_if<
                        std::is_convertible<U *, pointer>::value and is_default_manageable::value,
                        dummy_t_>::type = dummy_t_()) noexcept
    ...
    unique_impl_ptr(std::unique_ptr<U, D> and u,
                    typename std::enable_if<
                        std::is_convertible<U *, pointer>::value and std::is_convertible<D, deleter_type>::value,
                        dummy_t_>::type = dummy_t_()) noexcept
        : ptr_(std::move(u)) {}

    template <class U, class D>
    unique_impl_ptr(unique_impl_ptr<U, D> and u,
                    typename std::enable_if<
                        std::is_convertible<U *, pointer>::value and std::is_convertible<D, deleter_type>::value,
                        dummy_t_>::type = dummy_t_()) noexcept
    ...
    operator=(std::unique_ptr<U> and u) noexcept
    {
  ...
  public:
    ...
    impl_ptr(pointer p, D &&d, C &&c,
             typename std::enable_if<
                 std::is_convertible<D, deleter_type>::value and std::is_convertible<C, copier_type>::value,
                 typename base_type::dummy_t_>::type = typename base_type::dummy_t_()) noexcept
    ...
    template <class U>
    impl_ptr(std::unique_ptr<U> and u,
             typename std::enable_if<
                 std::is_convertible<U *, pointer>::value and is_default_manageable::value,
                 dummy_t_>::type = dummy_t_()) noexcept
    ...
    impl_ptr(std::unique_ptr<U, D> and u, C &&c,
             typename std::enable_if<
                 std::is_convertible<U *, pointer>::value and std::is_convertible<D, deleter_type>::value,
                 dummy_t_>::type = dummy_t_()) noexcept
    ...
    template <class U, class D, class C>
    typename std::enable_if<
        std::is_convertible<U *, pointer>::value and std::is_convertible<D, deleter_type>::value and std::is_convertible<C, copier_type>::value,
        impl_ptr &>::type
    ...
    typename std::enable_if<
        std::is_convertible<U *, pointer>::value and std::is_convertible<D, deleter_type>::value and std::is_convertible<C, copier_type>::value,
        impl_ptr &>::type
    operator=(impl_ptr<U, D, C> and u) noexcept
    {
  ...
  impl_ptr<U> make_derived_impl(Args &&...args)
  {
    return impl_ptr<U>(
        ...
        [](const U *ptr) -> U *
        { return new D(*static_cast<const D *>(ptr)); });
  }
...
{
  template <class T, class D>
  struct hash<multirobot_utils::unique_impl_ptr<T, D>>
  {
    using argument_type = multirobot_utils::unique_impl_ptr<T, D>;
  ...
  template <class T, class D, class C>
  struct hash<multirobot_utils::impl_ptr<T, D, C>>
  {
    using argument_type = multirobot_utils::impl_ptr<T, D, C>;
    using result_type = size_t;
...
#endif // MULTIROBOT_UTILS__IMPL_PTR_HPP
