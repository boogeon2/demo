...
#ifndef SRC__MULTIROBOT_UTILS__TRAJECTORYINTERNAL_HPP
#define SRC__MULTIROBOT_UTILS__TRAJECTORYINTERNAL_HPP
...
#endif // SRC__MULTIROBOT_UTILS__TRAJECTORYINTERNAL_HPP
