...
#ifndef MULTIROBOT_UTILS__TIME_HPP
#define MULTIROBOT_UTILS__TIME_HPP
...
namespace multirobot_utils
{
  ...
  namespace time
  {
    ...
    //==============================================================================
    rclcpp::Time to_ros2(Time time);

    //==============================================================================
    Time convert(rclcpp::Time time);
...
#endif // MULTIROBOT_UTILS__TIME_HPP
