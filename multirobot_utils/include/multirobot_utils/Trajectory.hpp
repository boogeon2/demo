...
#ifndef MULTIROBOT_UTILS__TRAJECTORY_HPP
#define MULTIROBOT_UTILS__TRAJECTORY_HPP
...
namespace multirobot_utils
{
  ...
  private:
    ...
    class Implementation;
    multirobot_utils::unique_impl_ptr<Implementation> _pimpl;
  };
  ...
  private:
    friend class Trajectory;
    friend class internal::TrajectoryIteratorImplementation;
    multirobot_utils::impl_ptr<internal::TrajectoryIteratorImplementation> _pimpl;
  };
...
#endif // MULTIROBOT_UTILS__TRAJECTORY_HPP
