...
#ifndef MULTIROBOT_UTILS__GEOMETRY__SHAPE_HPP
#define MULTIROBOT_UTILS__GEOMETRY__SHAPE_HPP
...
namespace multirobot_utils
{
  namespace geometry
  {
    ...
    /// by the multirobot_utils library. This cannot (currently) be extended
...
#endif // MULTIROBOT_UTILS__GEOMETRY__SHAPE_HPP
