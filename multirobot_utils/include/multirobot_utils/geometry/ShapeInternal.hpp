...
#ifndef SRC__MULTIROBOT_UTILS__GEOMETRY__SHAPEINTERNAL_HPP
#define SRC__MULTIROBOT_UTILS__GEOMETRY__SHAPEINTERNAL_HPP

#include "multirobot_utils/geometry/Shape.hpp"
#include "multirobot_utils/geometry/ConvexShape.hpp"
...
namespace multirobot_utils
{
  namespace geometry
  {
    ...
    {
    public:
      multirobot_utils::impl_ptr<const Shape> _shape;
      ...
      static FinalShape make_final_shape(
          multirobot_utils::impl_ptr<const Shape> shape,
          CollisionGeometries collisions,
          double characteristic_length,
          std::function<bool(const Shape &other)> compare_equality)
      {
        FinalShape result;
        result._pimpl = multirobot_utils::make_impl<Implementation>(
    ...
    public:
          ...
          std::function<bool(const Shape &other)> compare_equality)
      {
        ...
        result._pimpl = multirobot_utils::make_impl<FinalShape::Implementation>(
...
#endif // SRC__MULTIROBOT_UTILS__GEOMETRY__SHAPEINTERNAL_HPP
