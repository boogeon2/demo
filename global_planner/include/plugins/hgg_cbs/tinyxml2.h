...
#if defined(_DEBUG) or defined(DEBUG) or defined(__DEBUG__)
#ifndef DEBUG
#define DEBUG
#endif
#endif
...
namespace tinyxml2
{
    ...
    */
    ...
    public:
        ...
        {
            return !IsUTF8Continuation(p) and isspace(static_cast<unsigned char>(p));
        }
        ...
        {
            return IsNameStartChar(ch) or isdigit(ch) or ch == '.' or ch == '-';
        }
